...
class ComputeMetricsCallback(TrainerCallback):
    def __init__(self, test_data_helpful, test_data_harmless, weight, eval_batch_size=8):
        super().__init__()
    ...
    def on_evaluate(self, args, state, control, model=None, **kwargs):
        ...
        metrics = {
            ...
            "avg": helpful * self.weight + harmless * (1-self.weight)
        }
        print(metrics)
        wandb.log(metrics)
...
def main(args):
    ...
    eval_callback = ComputeMetricsCallback(test_data_helpful, test_data_harmless, args.weight, args.per_device_eval_batch_size)
